...
# input_img = cv2.imread('./TestData/01-CC10.jpg')
# input_img = cv2.cvtColor(input_img,cv2.COLOR_BGR2LAB)
...
#cv2.imwrite('normalized.jpg', input_img)


# template_img = cv2.imread('./TestData/01-HE.jpg')
# median = cv2.medianBlur(template_img, 75)
# plt.imshow(median)
# cv2.imwrite('median_HE.jpg', median)


# template_img = cv2.imread('./TestData/normalized.jpg')
# median = cv2.medianBlur(template_img, 75)
# plt.imshow(median)
# cv2.imwrite('median_CC10.jpg', median)